...
import edu.buffalo.cse.ir.wikiindexer.tokenizer.rules.DelimiterRule;
...
public class TokenizerFactory {
	...
	public Tokenizer getTokenizer(INDEXFIELD field) {
		...
		if (field == INDEXFIELD.TERM)
			try {
				return new Tokenizer(new WhitespaceRule(),new CapitalizationRule(),new StopWordsRule(),new PunctuationRule(),new SpecialCharRule(),new HyphenRule(),new ApostropheRule(),new StopWordsRule(),new DateRule(),new NumberRule(),new AccentRule(),new EnglishStemmer());
				//return new Tokenizer(new WhitespaceRule(),new CapitalizationRule(),new ApostropheRule(),new StopWordsRule(),new PunctuationRule(),new SpecialCharRule(),new HyphenRule(),new DateRule(),new NumberRule(),new AccentRule(),new EnglishStemmer());

...
public class SingleRunner {
	...
	private static void runIndexer(Properties properties) throws InterruptedException {
		...
		for (WikipediaDocument doc : list)
		{
			...
			String temp=doc.getTitle();
			
		}
		*/	
			
		//System.out.println("Number of unique documents "+docid.size());
		...
		try {
			//IndexReader my=new IndexReader(properties, INDEXFIELD.TERM);
			//int x=my.getTotalKeyTerms();
			//System.out.println(x);
			//IndexReader my=new IndexReader(properties, INDEXFIELD.LINK);
			//int x=my.getTotalKeyTerms();
			//Collection<String> mycoll=new ArrayList<String>();
			//System.out.println(docDict.getTotalTerms());
			//Map<String,Integer> mymap=new TreeMap<String,Integer>();
			// mycoll=my.getTopK(50);
		  // System.out.print(mycoll);
			//college,born,office
			//System.out.println(my.getTopK(50));
			termRunner.cleanup();
			authIdxer.cleanup();
			catIdxer.cleanup();
			linkIdxer.cleanup();
